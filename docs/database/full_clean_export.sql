...
-- ============================================
-- 4. 历史温湿度数据 - 最近7天 (每6小时一个数据点)
-- ============================================
-- 设备1 (A1-001): -2.5℃ 左右波动
INSERT INTO sensor_data (device_id, temperature, humidity, data_time) VALUES
(1, -2.30, 44.20, DATE_SUB(NOW(), INTERVAL 7 DAY)),
(1, -3.10, 42.80, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 18 HOUR)),
(1, -1.80, 46.50, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 12 HOUR)),
(1, -2.70, 43.90, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 6 HOUR)),
(1, -2.00, 45.10, DATE_SUB(NOW(), INTERVAL 6 DAY)),
(1, -3.20, 41.70, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 18 HOUR)),
(1, -1.50, 47.20, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 12 HOUR)),
(1, -2.80, 43.30, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 6 HOUR)),
(1, -2.20, 45.60, DATE_SUB(NOW(), INTERVAL 5 DAY)),
(1, -3.00, 42.10, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 18 HOUR)),
(1, -1.90, 46.80, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 12 HOUR)),
(1, -2.60, 44.50, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 6 HOUR)),
(1, -2.40, 43.80, DATE_SUB(NOW(), INTERVAL 4 DAY)),
(1, -2.90, 41.90, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 18 HOUR)),
(1, -1.70, 46.30, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 12 HOUR)),
(1, -2.50, 44.10, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 6 HOUR)),
(1, -2.10, 45.90, DATE_SUB(NOW(), INTERVAL 3 DAY)),
(1, -3.30, 42.50, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 18 HOUR)),
(1, -1.60, 47.00, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 12 HOUR)),
(1, -2.70, 43.70, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 6 HOUR)),
(1, -2.30, 45.30, DATE_SUB(NOW(), INTERVAL 2 DAY)),
(1, -2.80, 42.60, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 18 HOUR)),
(1, -1.90, 46.10, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 12 HOUR)),
(1, -2.40, 44.80, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 6 HOUR)),
(1, -2.50, 45.50, NOW());

-- 设备2 (A1-002): -1.8℃ 左右波动
INSERT INTO sensor_data (device_id, temperature, humidity, data_time) VALUES
(2, -1.50, 41.20, DATE_SUB(NOW(), INTERVAL 7 DAY)),
(2, -2.20, 39.80, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 18 HOUR)),
(2, -0.90, 43.50, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 12 HOUR)),
(2, -1.90, 40.90, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 6 HOUR)),
(2, -1.60, 42.10, DATE_SUB(NOW(), INTERVAL 6 DAY)),
(2, -2.40, 38.70, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 18 HOUR)),
(2, -1.20, 44.20, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 12 HOUR)),
(2, -2.00, 40.30, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 6 HOUR)),
(2, -1.70, 42.60, DATE_SUB(NOW(), INTERVAL 5 DAY)),
(2, -2.30, 39.10, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 18 HOUR)),
(2, -1.10, 43.80, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 12 HOUR)),
(2, -1.80, 41.50, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 6 HOUR)),
(2, -1.50, 40.80, DATE_SUB(NOW(), INTERVAL 4 DAY)),
(2, -2.10, 38.90, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 18 HOUR)),
(2, -0.80, 43.30, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 12 HOUR)),
(2, -1.80, 41.10, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 6 HOUR)),
(2, -1.40, 42.80, DATE_SUB(NOW(), INTERVAL 3 DAY)),
(2, -2.50, 39.50, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 18 HOUR)),
(2, -1.00, 44.00, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 12 HOUR)),
(2, -1.90, 40.70, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 6 HOUR)),
(2, -1.60, 42.30, DATE_SUB(NOW(), INTERVAL 2 DAY)),
(2, -2.10, 39.60, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 18 HOUR)),
(2, -1.20, 43.10, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 12 HOUR)),
(2, -1.80, 41.80, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 6 HOUR)),
(2, -1.80, 42.30, NOW());

-- 设备4 (B1-001): 5.6℃ 左右波动
INSERT INTO sensor_data (device_id, temperature, humidity, data_time) VALUES
(4, 5.20, 51.30, DATE_SUB(NOW(), INTERVAL 7 DAY)),
(4, 6.80, 48.70, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 18 HOUR)),
(4, 4.10, 55.20, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 12 HOUR)),
(4, 6.30, 47.50, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 6 HOUR)),
(4, 5.50, 50.80, DATE_SUB(NOW(), INTERVAL 6 DAY)),
(4, 7.20, 45.90, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 18 HOUR)),
(4, 3.80, 56.80, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 12 HOUR)),
(4, 6.10, 49.20, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 6 HOUR)),
(4, 5.30, 52.10, DATE_SUB(NOW(), INTERVAL 5 DAY)),
(4, 7.50, 46.30, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 18 HOUR)),
(4, 4.20, 57.50, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 12 HOUR)),
(4, 5.90, 50.10, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 6 HOUR)),
(4, 5.10, 51.60, DATE_SUB(NOW(), INTERVAL 4 DAY)),
(4, 6.80, 47.80, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 18 HOUR)),
(4, 3.50, 58.20, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 12 HOUR)),
(4, 5.70, 49.50, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 6 HOUR)),
(4, 5.40, 52.90, DATE_SUB(NOW(), INTERVAL 3 DAY)),
(4, 7.80, 44.60, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 18 HOUR)),
(4, 3.90, 55.70, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 12 HOUR)),
(4, 6.20, 48.30, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 6 HOUR)),
(4, 5.60, 51.20, DATE_SUB(NOW(), INTERVAL 2 DAY)),
(4, 7.10, 46.80, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 18 HOUR)),
(4, 4.50, 54.50, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 12 HOUR)),
(4, 5.80, 49.90, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 6 HOUR)),
(4, 5.60, 52.80, NOW());

-- 设备5 (B1-002): 6.2℃ 左右波动
INSERT INTO sensor_data (device_id, temperature, humidity, data_time) VALUES
(5, 5.80, 53.50, DATE_SUB(NOW(), INTERVAL 7 DAY)),
(5, 7.50, 56.80, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 18 HOUR)),
(5, 4.20, 47.20, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 12 HOUR)),
(5, 6.90, 54.10, DATE_SUB(NOW(), INTERVAL 6 DAY + INTERVAL 6 HOUR)),
(5, 6.10, 52.90, DATE_SUB(NOW(), INTERVAL 6 DAY)),
(5, 8.10, 58.30, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 18 HOUR)),
(5, 4.80, 49.60, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 12 HOUR)),
(5, 6.50, 55.20, DATE_SUB(NOW(), INTERVAL 5 DAY + INTERVAL 6 HOUR)),
(5, 5.90, 51.70, DATE_SUB(NOW(), INTERVAL 5 DAY)),
(5, 7.80, 57.60, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 18 HOUR)),
(5, 4.50, 48.50, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 12 HOUR)),
(5, 6.30, 53.80, DATE_SUB(NOW(), INTERVAL 4 DAY + INTERVAL 6 HOUR)),
(5, 6.00, 54.20, DATE_SUB(NOW(), INTERVAL 4 DAY)),
(5, 7.20, 56.90, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 18 HOUR)),
(5, 4.90, 49.80, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 12 HOUR)),
(5, 6.40, 52.60, DATE_SUB(NOW(), INTERVAL 3 DAY + INTERVAL 6 HOUR)),
(5, 6.20, 55.50, DATE_SUB(NOW(), INTERVAL 3 DAY)),
(5, 8.30, 59.10, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 18 HOUR)),
(5, 5.10, 48.90, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 12 HOUR)),
(5, 6.70, 53.20, DATE_SUB(NOW(), INTERVAL 2 DAY + INTERVAL 6 HOUR)),
(5, 5.90, 54.80, DATE_SUB(NOW(), INTERVAL 2 DAY)),
(5, 7.40, 57.30, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 18 HOUR)),
(5, 4.70, 50.20, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 12 HOUR)),
(5, 6.50, 52.80, DATE_SUB(NOW(), INTERVAL 1 DAY + INTERVAL 6 HOUR)),
(5, 6.20, 55.30, NOW());
